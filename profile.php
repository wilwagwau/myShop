	        ...
	        <div class="row">
	        	<div class="col-sm-9">
	        		...
	        		<div class="box box-solid">
	        			<div class="box-body">
	        				<div class="col-sm-3">
	        					<img src="<?php echo (!empty($user['photo'])) ? 'images/users/'.$user['photo'] : 'images/users/profile.jpg'; ?>" width="90%" 
													style="border: 1px solid orange; border-top-left-radius: 30px; border-bottom-right-radius: 30px;" >
	        				</div>
	        				<div class="col-sm-9">
	        					<div class="row">
	        						<div class="col-sm-3">
	        						...
	        						<div class="col-sm-9">
	        							<h5><?php echo $user['firstname'].' '.$user['lastname']; ?>
	        								<span class="pull-right">
														...
														<a href="logout.php" class="btn btn-warning btn-flat btn-sm"><i class="fa fa-power-off"></i> Logout</a>
	        								</span>
	        							</h5>
