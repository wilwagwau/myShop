<header class="main-header">
  ...
  <a href="#" class="logo">
    ...
    <span class="logo-mini" style="color: wheat">m<b><span style="color: orange">S</span></b></span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg" style="color: wheat">my<b><span style="color: orange">Shop</span></b></span>
  </a>
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-header">
              ...
              <p>
                ...
                <small>Joined on <?php echo date('M-d, Y', strtotime($admin['created_on'])); ?></small>
              </p>
            </li>
